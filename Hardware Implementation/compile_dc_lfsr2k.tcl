...
set my_verilog_files [list  $First_Path/lfsr2048.sv]
...
redirect Outputs/timing_45lfsr2k.txt { report_timing -transition_time}
redirect Outputs/power_45lfsr2k.txt { report_power }
redirect Outputs/area_45lfsr2k.txt { report_area }
report_timing
