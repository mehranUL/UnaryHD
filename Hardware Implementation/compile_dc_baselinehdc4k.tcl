...
set my_verilog_files [list  $First_Path/baseline_hdc4k.sv]
...
redirect Outputs/timing_45bl4k.txt { report_timing -transition_time}
redirect Outputs/power_45bl4k.txt { report_power }
redirect Outputs/area_45bl4k.txt { report_area }
report_timing
