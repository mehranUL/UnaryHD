...
set my_verilog_files [list  $First_Path/random_flip2k.sv]
...
redirect Outputs/timing_45rf2k.txt { report_timing -transition_time}
redirect Outputs/power_45rf2k.txt { report_power }
redirect Outputs/area_45rf2k.txt { report_area }
report_timing
