...
set my_verilog_files [list  $First_Path/lfsr8192.sv]
set my_toplevel lfsr
...
redirect Outputs/timing_45lfsr8k.txt { report_timing -transition_time}
redirect Outputs/power_45lfsr8k.txt { report_power }
redirect Outputs/area_45lfsr8k.txt { report_area }
report_timing
