...
set my_verilog_files [list  $First_Path/hdc_main.sv]
set my_toplevel hdc_main
...
redirect Outputs/timing_45hdc1k.txt { report_timing -transition_time}
redirect Outputs/power_45hdc1k.txt { report_power }
redirect Outputs/area_45hdc1k.txt { report_area }
report_timing
