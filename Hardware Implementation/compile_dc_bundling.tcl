...
set my_verilog_files [list  $First_Path/bundling.sv]
set my_toplevel bundling
...
redirect Outputs/timing_45bundling1k2.txt { report_timing -transition_time}
redirect Outputs/power_45bundling1k2.txt { report_power }
redirect Outputs/area_45bundling1k2.txt { report_area }
report_timing
