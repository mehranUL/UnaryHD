...
set my_verilog_files [list  $First_Path/baseline_hdc_new.sv]
set my_toplevel baseline_hdc
...
redirect Outputs/timing_45blnew1k.txt { report_timing -transition_time}
redirect Outputs/power_45blnew1k.txt { report_power }
redirect Outputs/area_45blnew1k.txt { report_area }
report_timing
