...
set my_verilog_files [list  $First_Path/hv_gen_new.sv]
set my_toplevel hv_generator
...
redirect Outputs/timing_45hvgen.txt { report_timing -transition_time}
redirect Outputs/power_45hvgen.txt { report_power }
redirect Outputs/area_45hvgen.txt { report_area }
report_timing
