...
set my_verilog_files [list  $First_Path/comparator.sv]
...
redirect Outputs/timing_45comp1k.txt { report_timing -transition_time}
redirect Outputs/power_45comp1k.txt { report_power }
redirect Outputs/area_45comp1k.txt { report_area }
report_timing
